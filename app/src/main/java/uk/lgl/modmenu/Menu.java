...
public class Menu {
    ...
    public Menu(Context context) {
       ...
       //mExpanded.setBackground(gdMenuBody); //Apply GradientDrawable to it
        ...
        scrollView.setBackgroundColor(trans);
        ...
        android.graphics.drawable.GradientDrawable ICAACCE = new android.graphics.drawable.GradientDrawable();
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (Preferences.loadPref && !IsGameLibLoaded() && !stopChecking) {
                    if (!viewLoaded) {
                        Category(mods, "Waiting For Game To Be Loaded.");
    ...
    private void featureList(String[] listFT, LinearLayout linearLayout) {
        ...
        for (int i = 0; i < listFT.length; i++) {
            ...
            switch (strSplit[0]) {
                ...
                case "RedAlert":
                    subFeat++;
                    RedAlert(linearLayout, strSplit[1]);
                    break;
            }
        }
    }
    ...
    private void ButtonLink(LinearLayout linLayout, final String featName, final String url) {
        ...
        button.setTextColor(TEXT_COLOR_2);
        button.setText(Html.fromHtml(featName));
        button.setBackgroundColor(trans);
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
    ...
    private void Spinner(LinearLayout linLayout, final int featNum, final String featName, final String list) {
        ...
        DAJHEFD.setStroke(3, Color.CYAN);
        DAJHEFD.setCornerRadii(new float[] { 50, 50, 30, 30, 30, 30, 30, 30 });
        linearLayout2.setBackground(DAJHEFD);
    ...
    private void RedAlert(LinearLayout linLayout,String text) {
    ...
    private void Collapse(LinearLayout linLayout, final String text, final boolean expanded) {
        ...
        collapseSub.setBackgroundColor(trans);
