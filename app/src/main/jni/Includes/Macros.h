...
#define NepmodsHook(lib, offset, ptr, orig) hook((void *)getAbsoluteAddress(lib, string2Offset(offset)), (void *)ptr, (void **)&orig)
...
#define NepPatch(lib, offset, hex) patchOffset(lib, string2Offset(offset), hex, true)
...
#define NepRestore(lib, offset) patchOffset(lib, string2Offset(offset), "", false)
